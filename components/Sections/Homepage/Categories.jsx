          ...
          <div className="grid xl:grid-cols-8 lg:grid-cols-6 sm:grid-cols-5 grid-cols-4 sm:gap-5 gap-3">
            {datas.map((category, i) => (
              <Link
                ...
                className="categories-item w-full sm:h-[142px] h-[100px] flex justify-center items-center p-2 rounded-[5px] bg-black border border-primary-border hover:shadow-lg hover:border-primary-blue hover:shadow-[#45F882] common-transition group"
              >
