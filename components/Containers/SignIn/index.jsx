  ...
  return (
    <div className="w-full bg-black rounded-[5px] md:px-[60px] md:py-10 p-5">
      ...
      <div className="grid grid-cols-2 gap-[30px] mb-5">
        <div className="col-span-full w-full">
          <div className="input-field h-[50px] relative">
            <label className="text-sm bg-black text-white bg-opacity-30 absolute rtl:left-auto ltr:rtl:left-auto rtl:right-3 ltr:left-3 ltr:right-auto -top-[9px]  inline-block px-[5px]">
              Email*
            </label>
            <input
              type="text"
      ...
      <button
        ...
        className="w-full h-[62px] rounded bg-primary-blue text-black flex justify-center items-center text-[18px] font-semibold tracking-wider mb-3"
      >
        <StringLang string="Sign In" />
      </button>
