          ...
          <div className="w-[160px] h-[126px] relative rounded overflow-hidden">
            ...
            <div className="absolute top-[6px] left-[6px]">
              <button
                ...
                type="button"
                className={`w-7 h-7 bg-white text-[#616161] items-center justify-center flex hover:bg-primary-blue common-transition  hover:text-black  rounded-full`}
              >
                <span>
          ...
          <div className="w-full h-[194px] relative  rounded-t overflow-hidden">
            ...
            <div className="absolute top-[6px] left-[6px]">
              <button
                ...
                className={`w-7 h-7 items-center justify-center flex hover:bg-primary-blue common-transition  hover:text-black bg-white text-[#616161] 
                 rounded-full`}
              >
                <span>
                  {data?.products?.find((item) => item?.slug === slug) ? (
